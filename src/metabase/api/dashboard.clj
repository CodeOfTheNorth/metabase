...
(defn- hashes->hash-vec->avg-time
  "Given some query HASHES, return a map of the hex representation of the hash to the average query duration.
   (The hashes are represented as hex because identical byte arrays aren't considered equal to one another, and thus do not
